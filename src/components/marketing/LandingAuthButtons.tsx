...
const SHINE_BUTTON_CLASS =
  "landing-btn-shine relative inline-flex h-12 items-center justify-center overflow-hidden rounded-lg px-10 text-sm font-semibold bg-parsel-gold text-parsel-bg transition-colors duration-500 hover:bg-parsel-gold/90";

const OUTLINE_BUTTON_CLASS =
  "inline-flex h-12 items-center justify-center rounded-lg border border-zinc-800/80 bg-[#18181b] px-10 text-sm font-medium text-zinc-400 transition-colors hover:border-zinc-700 hover:text-zinc-100";
...
const NAV_SIGN_IN_CLASS =
  "inline-flex items-center justify-center rounded-lg px-4 py-2.5 text-sm font-semibold text-parsel-textMuted transition-colors duration-300 hover:text-parsel-textMain";

const NAV_SIGN_UP_CLASS =
  "inline-flex items-center justify-center rounded-lg border border-parsel-gold/30 bg-parsel-gold px-5 py-2.5 text-sm font-semibold text-parsel-bg transition-colors duration-300 hover:bg-parsel-gold/90";

function AuthNavSkeleton() {
  return <div className="h-10 w-40 animate-pulse rounded-lg bg-white/5" />;
}
...
export const HERO_GOLD_BUTTON_CLASS =
  "relative inline-flex overflow-hidden animate-[pulse_3s_cubic-bezier(0.4,0,0.6,1)_infinite] bg-[#b38c56] px-8 py-4 font-outfit text-sm font-semibold text-zinc-950 shadow-lg shadow-[#b38c56]/20 transition-all hover:bg-[#c5a36e] rounded-xl";

const HERO_DEMO_BUTTON_CLASS =
  "inline-flex items-center justify-center rounded-xl border border-white/10 bg-white/5 px-8 py-4 font-outfit text-sm font-medium text-zinc-200 backdrop-blur-xl transition-all hover:bg-white/10 hover:text-white";
    ...
    <>
      <ClerkLoading>
        ...
        >
          ...
          <div className="h-full w-32 rounded-xl bg-white/5" />
        </div>
      </ClerkLoading>
      <ClerkLoaded>
...
export function LandingCtaAuth() {
  return (
    <>
      <ClerkLoading>
        <div className="mx-auto mt-12 h-12 w-48 animate-pulse rounded-lg bg-white/5" />
      </ClerkLoading>
      <ClerkLoaded>
        <LoadedCtaAction />
      </ClerkLoaded>
