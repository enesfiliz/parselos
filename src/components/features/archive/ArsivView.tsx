      ...
      {isLoading ? (
          ...
          {Array.from({ length: 6 }).map((_, index) => (
            ...
            >
              <CardHeader className="space-y-3">
                <div className="h-4 w-2/3 animate-pulse rounded bg-parsel-card/40" />
                <div className="h-3 w-1/2 animate-pulse rounded bg-parsel-card/40" />
              </CardHeader>
              <CardContent>
                <div className="h-9 w-full animate-pulse rounded-lg bg-parsel-card/40" />
              </CardContent>
            </Card>
          ))}
        </div>
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {reports.map((item) => (
            <Card
              key={item.id}
              className="flex flex-col border-border/60 shadow-lg ring-1 ring-parsel-border/80 transition-shadow hover:shadow-xl"
            >
