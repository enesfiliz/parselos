    ...
    <div className="space-y-6">
      <header className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <p className="mt-1 max-w-2xl text-sm font-light text-zinc-500">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="inline-flex items-center gap-2 rounded-xl border border-white/[0.06] bg-[#0f1417] px-4 py-2.5">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-[#b38c56] px-5 py-2.5 text-sm font-semibold text-black transition-colors hover:bg-[#c2985e]"
          >
